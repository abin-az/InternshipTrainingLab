...
- **Hardware**: Dell PowerEdge R640 (1U Rackmount, PERC H730 Mini in HBA Mode, 2x 960GB Samsung Enterprise SSDs in ZFS RAID-1, Dual Redundant PSUs, iDRAC9 Enterprise).
- **Hypervisor**: Proxmox VE 9.2-1 (Host IP: `192.168.29.25/24`, Gateway: `192.168.29.1`).
- **Complete Deployment Guide**: Refer to [dell_poweredge_r640_proxmox_deployment.md](file:///c:/Users/abinu/Documents/antigravity/optimistic-meitner/00_prerequisites/dell_poweredge_r640_proxmox_deployment.md) for the iDRAC connection, HBA conversion, ZFS mirror setup, and repository optimization.
